...
public class CardGame {
    ...
    public void moveCards() {
        for (int i = 0; i < 4; i++) {
            for (int n = 0; n < noOfPlayers; n++) {
                players.get(n).addCardtoHand(pack.get(n * noOfPlayers + n));
            }
        }
        for (int i = 0; i < 4; i++) {
            for (int n = 0; n < noOfPlayers; n++) {
    ...
    // starts the game by starting the player's run methods
    public void startGame() {

        // checks if a player has won of their initial hand
        for (int n = 0; n < noOfPlayers; n++) {
